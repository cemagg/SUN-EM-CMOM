...
struct CBFMZMatrices 
{
	...
	std::complex<double> *z_self_piv; // Pivot vector of inverse Zmn self
	...
	std::vector<std::vector<std::complex<double>*>> z_couple_piv; // Vector of vectors for inverse Zmn coupling pivot vectors
};
